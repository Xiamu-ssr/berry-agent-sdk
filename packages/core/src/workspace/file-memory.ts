 ...
 *
 * Used by the pre-compact memory flush pipeline. Search/retrieval is
 * intentionally **not** a responsibility of this class — that belongs to a
 * MemoryProvider (see `@berry-agent/memory-file` for the default FTS5-backed
 * implementation). Keeping responsibilities split means compaction and
